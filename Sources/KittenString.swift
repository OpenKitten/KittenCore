...
public protocol KittenString : Hashable {
...
public class KittenBytes : KittenString, SimpleConvertible, ExpressibleByStringLiteral {
    ...
    public required init(unicodeScalarLiteral value: StaticString) {
        self.bytes = value.kittenBytes.bytes
    }
    
    public required init(extendedGraphemeClusterLiteral value: StaticString) {
        self.bytes = value.kittenBytes.bytes
    }
    
    public var hashValue: Int {
        let table: [UInt32] = [0x00000000, 0x04C11DB7, 0x09823B6E, 0x0D4326D9,
